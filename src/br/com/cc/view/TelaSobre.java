...
public class TelaSobre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cadastro de Chamados Simpress");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel3.setText("Criado por Alexsandro Luiz de Faria");

        jLabel4.setText("Versão - 1.0");

        jLabel5.setText("Relatórios por Ireport 5.6.0");

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel6.setText("Aviso:");

        jLabel7.setText("Aplicativo construido para uso pessoal, não sendo responsabilizado por uso de");

        jLabel8.setText("terceiros. Aplicativo não comercial.");
